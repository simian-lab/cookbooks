...
when 'debian'
  ...
  when 'ubuntu'
    ...
    when 18.04
      ...
      default['php']['mysql']['package'] = 'php-mysql'
      default['php']['curl']['package']  = 'php-curl'
      default['php']['apc']['package']   = 'php-apc'
      default['php']['apcu']['package']  = 'php-apcu'
      default['php']['gd']['package']    = 'php-gd'
      default['php']['ldap']['package']  = 'php-ldap'
      default['php']['pgsql']['package'] = 'php-pgsql'
      default['php']['sqlite']['package'] = 'php-sqlite3'
      default['php']['fpm_package']      = 'php-fpm'
      default['php']['fpm_pooldir']      = '/etc/php/7.4/fpm/pool.d'
      default['php']['fpm_service']      = 'php-fpm'
      default['php']['fpm_socket']       = '/var/run/php/php-fpm.sock'
